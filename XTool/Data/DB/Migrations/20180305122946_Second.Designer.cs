...
namespace XTool.Migrations
{
    ...
    [Migration("20180305122946_Second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XTool.Models.ActorModels.BaseTypes.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("XTool.Models.ActorModels.BiographyEvent", b =>
                {
                    b.HasBaseType("XTool.Models.ActorModels.BaseTypes.Event");

                    b.Property<int>("ActorId");

                    b.HasIndex("ActorId");

                    b.ToTable("BiographyEvent");

                    b.HasDiscriminator().HasValue("BiographyEvent");
                });
            ...
            modelBuilder.Entity("XTool.Models.ActorModels.CareerEvent", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CareerEvent");
                });

            modelBuilder.Entity("XTool.Models.ActorModels.Photo", b =>
                {
                    b.HasBaseType("XTool.Models.ActorModels.BaseTypes.Media");
